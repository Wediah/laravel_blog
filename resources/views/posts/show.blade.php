            ...
            <article class="max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10">
                <div class="col-span-4 lg:text-center lg:pt-14 mb-10">
                    ...
                    <div class="flex items-center lg:justify-center text-sm mt-4">
                        ...
                        <div class="ml-3 text-left">
                            <a href="/?author={{ $post->author->username }}"><h5 class="font-bold">{{
                ...
                <section class="mt-10 col-span-8 col-start-5 space-y-6">
                    ...
                    <form method="POST" action="" >
                        ...
                        <div class="mt-6 mb-2">
                            <textarea name="" id=""  rows="5" class="w-full text-sm focus:outline-none
                            focus:ring p-2 rounded-xl" placeholder="Quick,
                            think of something ton say"></textarea>
                        </div>
